export function HeaderFilter({isExpanded, setIsExpanded}) {
    console.log('is EXPANEDED:', isExpanded)
    return (
        <>
            {isExpanded && (
                <form className="filter-container expanded">
                    ...
                    <button className="filter-search long-btn"><svg
            ...
            {!isExpanded && (
                <form className="filter-container not-expanded" onClick={()=> setIsExpanded(true)}>
                    ...
                    <button className="filter-search short-btn"><svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 32 32"
                        width="13"
                        height="13"
